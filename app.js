...
const holidaySeed = [
  ["2025-10-29", "Осенние каникулы"],
  ["2025-10-30", "Осенние каникулы"],
  ["2025-10-31", "Осенние каникулы"],
  ["2025-11-01", "Осенние каникулы"],
  ["2025-11-02", "Осенние каникулы"],
  ["2025-12-29", "Зимние каникулы"],
  ["2025-12-30", "Зимние каникулы"],
  ["2025-12-31", "Зимние каникулы"],
  ["2026-01-01", "Зимние каникулы"],
  ["2026-01-02", "Зимние каникулы"],
  ["2026-01-03", "Зимние каникулы"],
  ["2026-01-04", "Зимние каникулы"],
  ["2026-01-05", "Зимние каникулы"],
  ["2026-01-06", "Зимние каникулы"],
  ["2026-01-07", "Зимние каникулы"],
  ["2026-01-08", "Зимние каникулы"],
  ["2026-01-09", "Зимние каникулы"],
  ["2026-01-10", "Зимние каникулы"],
  ["2026-01-11", "Зимние каникулы"],
  ["2026-02-23", "День защитника Отечества"],
  ["2026-03-09", "Международный женский день"],
  ["2026-03-23", "Весенние каникулы"],
  ["2026-03-24", "Весенние каникулы"],
  ["2026-03-25", "Весенние каникулы"],
  ["2026-03-26", "Весенние каникулы"],
  ["2026-03-27", "Весенние каникулы"],
  ["2026-03-28", "Весенние каникулы"],
  ["2026-03-29", "Весенние каникулы"],
  ["2026-03-30", "Весенние каникулы"],
  ["2026-03-31", "Весенние каникулы"],
...
function migrateState(data) {
  ...
  if (data.academicPlanVersion !== "2025-2026-v1") {
    data.holidays = holidaySeed.map(([date, name]) => ({ id: crypto.randomUUID(), date, name }));
    data.academicPlanVersion = "2025-2026-v1";
  }
...
function renderEmployeeSelect() {
  ...
  document.querySelector("#activeEmployeeMeta").textContent = employee
    ? `${employee.role} · ${isAdmin() ? "администратор" : "преподаватель"} · 2025-2026 учебный год`
...
function renderSchedulePrintSheet() {
  ...
  return `
    <section class="schedule-print-sheet" aria-hidden="true">
      ...
      <p class="schedule-print-year">на 2025-2026 уч. год</p>
...
function holidayName(date) {
  return state.holidays.find((holiday) => holiday.date === date)?.name || "Праздник";
}
