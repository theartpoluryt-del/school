...
const lessonTypes = ["Специальность", "Музыкальный инструмент", "Постановка голоса", "Дирижирование", "Сольное пение", "Сценическая речь", "Ансамбль", "Оркестр", "Хор", "Коллективное музицирование", "Сольфеджио", "Музыкальная литература", "Элементарная теория музыки", "Слушание музыки", "Концертмейстер"];
